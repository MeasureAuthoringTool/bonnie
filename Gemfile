...
gem 'bonnie_bundler', :git => 'https://github.com/projecttacoma/bonnie_bundler.git', :branch => 'fixes_for_bonnie_integration'
...
gem 'cqm-models', :git => 'https://github.com/projecttacoma/cqm-models', :branch => 'fixes_for_bonnie_integration'
