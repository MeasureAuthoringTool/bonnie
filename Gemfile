...
gem 'cqm-converter', :git => 'https://github.com/projecttacoma/cqm-converter', :branch => 'cqm_measure_converter'
gem 'cqm-models', :git => 'https://github.com/projecttacoma/cqm-models', :branch => 'measure_object_updates_rebase'
