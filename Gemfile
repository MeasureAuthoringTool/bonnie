...
gem 'cqm-converter', :git => 'https://github.com/projecttacoma/cqm-converter', :branch => 'patient_expected_values'
gem 'cqm-models', :git => 'https://github.com/projecttacoma/cqm-models', :branch => 'patient_expected_values'
