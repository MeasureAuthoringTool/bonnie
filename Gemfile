...
gem 'cqm-converter', :git => 'https://github.com/projecttacoma/cqm-converter', :branch => 'measure_ids'
gem 'cqm-parsers', :git => 'https://github.com/projecttacoma/cqm-parsers', :branch => 'bonnie_version'
gem 'cqm-models', :git => 'https://github.com/projecttacoma/cqm-models', :branch => 'measure_ids'
