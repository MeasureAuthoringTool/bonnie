...
gem 'cql_qdm_patientapi', :git => 'https://github.com/projecttacoma/cql_qdm_patientapi.git', :branch => 'bonnie-v3.1.1-max-only'
...
gem 'cqm-converter', :git => 'https://github.com/projecttacoma/cqm-converter', :branch => 'bonnie-v3.1.1-max-only'
