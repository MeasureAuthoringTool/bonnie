      ...
      def before_successful_response
        refresh_token.transaction do
          ...
          if !Doorkeeper.configuration.refresh_token_expires_in.nil?
            ...
            if !refresh_token.original_token_created_at.nil?
              refresh_token_expiration_time = refresh_token.original_token_created_at + Doorkeeper.configuration.refresh_token_expires_in
            else
              refresh_token_expiration_time = refresh_token.created_at + Doorkeeper.configuration.refresh_token_expires_in
            end
          ...
          token.original_token_created_at = refresh_token.original_token_created_at if !refresh_token.original_token_created_at.nil?
          token.save!
