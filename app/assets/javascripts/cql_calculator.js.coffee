@CQLCalculator = class CQLCalculator
  ...
  # The format of this JSON was obtained by creating an funcion in the MAT and seeing how the CQLTranslation JAR output the funciton when passed the corresponding ELM
