@FhirValueSets = class FhirValueSets
  ...
  @bindingsCodeSystemMap: ->
    ...
    @_codeSystemMap['http://hl7.org/fhir/v3/ActMood'] = 'ActMood'
    @_codeSystemMap['http://hl7.org/fhir/v3/ActPriority'] = 'ActPriority'
    @_codeSystemMap['http://hl7.org/fhir/v3/ActReason'] = 'ActReason'
    @_codeSystemMap['http://hl7.org/fhir/v3/ActRelationshipType'] = 'ActRelationshipType'
    @_codeSystemMap['http://hl7.org/fhir/v3/ActStatus'] = 'ActStatus'
    @_codeSystemMap['http://hl7.org/fhir/v3/AddressUse'] = 'AddressUse'
    @_codeSystemMap['http://hl7.org/fhir/v3/AdministrativeGender'] = 'AdministrativeGender'
    @_codeSystemMap['http://hl7.org/fhir/v2/0001'] = 'AdministrativeSex'
    @_codeSystemMap['http://www.nlm.nih.gov/research/umls/cdt'] = 'CDT'
    @_codeSystemMap['http://hl7.org/fhir/sid/cvx'] = 'CVX'
    @_codeSystemMap['http://hl7.org/fhir/v3/Confidentiality'] = 'Confidentiality'
    @_codeSystemMap['http://hl7.org/fhir/v2/0112'] = 'DischargeDisposition'
    @_codeSystemMap['http://hl7.org/fhir/v3/EntityNamePartQualifier'] = 'EntityNamePartQualifier'
    @_codeSystemMap['http://hl7.org/fhir/v3/EntityNameUse'] = 'EntityNameUse'
    @_codeSystemMap['http://hl7.org/fhir/v3/LanguageAbilityMode'] = 'LanguageAbilityMode'
    @_codeSystemMap['http://hl7.org/fhir/v3/LanguageAbilityProficiency'] = 'LanguageAbilityProficiency'
    @_codeSystemMap['http://hl7.org/fhir/v3/LivingArrangement'] = 'LivingArrangement'
    @_codeSystemMap['http://hl7.org/fhir/v3/MaritalStatus'] = 'MaritalStatus'
    @_codeSystemMap['http://www.nlm.nih.gov/research/umls/MED-RT'] = 'MED-RT'
    @_codeSystemMap['http://ncimeta.nci.nih.gov'] = 'NCI'
    @_codeSystemMap['http://hl7.org/fhir/ndfrt'] = 'NDFRT'
    @_codeSystemMap['http://nucc.org/provider-taxonomy'] = 'NUCCPT'
    @_codeSystemMap['http://hl7.org/fhir/v3/NullFlavor'] = 'NullFlavor'
    @_codeSystemMap['http://hl7.org/fhir/v3/ObservationInterpretation'] = 'ObservationInterpretation'
    @_codeSystemMap['http://hl7.org/fhir/v3/ObservationValue'] = 'ObservationValue'
    @_codeSystemMap['http://hl7.org/fhir/v3/ParticipationFunction'] = 'ParticipationFunction'
    @_codeSystemMap['http://hl7.org/fhir/v3/ParticipationMode'] = 'ParticipationMode'
    @_codeSystemMap['http://hl7.org/fhir/v3/ParticipationType'] = 'ParticipationType'
    @_codeSystemMap['http://www.nlm.nih.gov/research/umls/rxnorm'] = 'RXNORM'
    @_codeSystemMap['http://hl7.org/fhir/v3/ReligiousAffiliation'] = 'ReligiousAffiliation'
    @_codeSystemMap['http://hl7.org/fhir/v3/RoleClass'] = 'RoleClass'
    @_codeSystemMap['http://hl7.org/fhir/v3/RoleCode'] = 'RoleCode'
    @_codeSystemMap['http://hl7.org/fhir/v3/RoleStatus'] = 'RoleStatus'
    @_codeSystemMap['http://www.nlm.nih.gov/research/umls/sop'] = 'SOP'
    @_codeSystemMap['http://unitsofmeasure.org'] = 'UCUM'
  ...
  @codeSystemFhirUriMap: ->
    return @_codeSystemFhirMap if @_codeSystemFhirMap?
    @_codeSystemFhirMap = {}
    # TODO: move this to parser
    @_codeSystemFhirMap['medication-statement-status'] = 'http://hl7.org/fhir/CodeSystem/medication-statement-status'
    @_codeSystemFhirMap['medicationrequest-intent'] = 'http://hl7.org/fhir/CodeSystem/medicationrequest-intent'
    @_codeSystemFhirMap['medicationrequest-status'] = 'http://hl7.org/fhir/CodeSystem/medicationrequest-status'
    ...
    @_codeSystemFhirMap['request-intent'] = 'http://hl7.org/fhir/request-intent'
    @_codeSystemFhirMap['admit-source'] = 'http://terminology.hl7.org/CodeSystem/admit-source'
    ...
    @_codeSystemFhirMap['ObservationCategoryCodes'] = 'http://terminology.hl7.org/CodeSystem/observation-category'
    @_codeSystemFhirMap['LOINCCodes'] = 'http://loinc.org'
    # Source: https://www.hl7.org/fhir/terminologies-systems.html#tabs-ext & https://cts.nlm.nih.gov/fhir/index.html
    @_codeSystemFhirMap['LOINC'] = 'http://loinc.org'
    @_codeSystemFhirMap['SNOMEDCT'] = 'http://snomed.info/sct'
    @_codeSystemFhirMap['SNOMED CT'] = 'http://snomed.info/sct'
    @_codeSystemFhirMap['SNOMEDCT:2017-09'] = 'http://snomed.info/sct'
    @_codeSystemFhirMap['CPT'] = 'http://www.ama-assn.org/go/cpt'
    # Source: https://cts.nlm.nih.gov/fhir/index.html
    @_codeSystemFhirMap['SOP'] = 'http://www.nlm.nih.gov/research/umls/sop'
    @_codeSystemFhirMap['ICD9CM'] = 'http://hl7.org/fhir/sid/icd-9-cm'
    @_codeSystemFhirMap['ICD10PCS'] = 'http://www.icd10data.com/icd10pcs'
    @_codeSystemFhirMap['ICD10CM'] = 'http://hl7.org/fhir/sid/icd-10-cm'
    @_codeSystemFhirMap['ActMood'] = 'http://hl7.org/fhir/v3/ActMood'
    @_codeSystemFhirMap['ActPriority'] = 'http://hl7.org/fhir/v3/ActPriority'
    @_codeSystemFhirMap['ActReason'] = 'http://hl7.org/fhir/v3/ActReason'
    @_codeSystemFhirMap['ActRelationshipType'] = 'http://hl7.org/fhir/v3/ActRelationshipType'
    @_codeSystemFhirMap['ActStatus'] = 'http://hl7.org/fhir/v3/ActStatus'
    @_codeSystemFhirMap['AddressUse'] = 'http://hl7.org/fhir/v3/AddressUse'
    @_codeSystemFhirMap['AdministrativeGender'] = 'http://hl7.org/fhir/v3/AdministrativeGender'
    @_codeSystemFhirMap['AdministrativeSex'] = 'http://hl7.org/fhir/v2/0001'
    @_codeSystemFhirMap['CDT'] = 'http://www.nlm.nih.gov/research/umls/cdt'
    @_codeSystemFhirMap['CVX'] = 'http://hl7.org/fhir/sid/cvx'
    @_codeSystemFhirMap['Confidentiality'] = 'http://hl7.org/fhir/v3/Confidentiality'
    @_codeSystemFhirMap['DischargeDisposition'] = 'http://hl7.org/fhir/v2/0112'
    @_codeSystemFhirMap['EntityNamePartQualifier'] = 'http://hl7.org/fhir/v3/EntityNamePartQualifier'
    @_codeSystemFhirMap['EntityNameUse'] = 'http://hl7.org/fhir/v3/EntityNameUse'
    @_codeSystemFhirMap['LanguageAbilityMode'] = 'http://hl7.org/fhir/v3/LanguageAbilityMode'
    @_codeSystemFhirMap['LanguageAbilityProficiency'] = 'http://hl7.org/fhir/v3/LanguageAbilityProficiency'
    @_codeSystemFhirMap['LivingArrangement'] = 'http://hl7.org/fhir/v3/LivingArrangement'
    @_codeSystemFhirMap['MaritalStatus'] = 'http://hl7.org/fhir/v3/MaritalStatus'
    @_codeSystemFhirMap['MED-RT'] = 'http://www.nlm.nih.gov/research/umls/MED-RT'
    @_codeSystemFhirMap['NCI'] = 'http://ncimeta.nci.nih.gov'
    @_codeSystemFhirMap['NDFRT'] = 'http://hl7.org/fhir/ndfrt'
    @_codeSystemFhirMap['NUCCPT'] = 'http://nucc.org/provider-taxonomy'
    @_codeSystemFhirMap['NullFlavor'] = 'http://hl7.org/fhir/v3/NullFlavor'
    @_codeSystemFhirMap['ObservationInterpretation'] = 'http://hl7.org/fhir/v3/ObservationInterpretation'
    @_codeSystemFhirMap['ObservationValue'] = 'http://hl7.org/fhir/v3/ObservationValue'
    @_codeSystemFhirMap['ParticipationFunction'] = 'http://hl7.org/fhir/v3/ParticipationFunction'
    @_codeSystemFhirMap['ParticipationMode'] = 'http://hl7.org/fhir/v3/ParticipationMode'
    @_codeSystemFhirMap['ParticipationType'] = 'http://hl7.org/fhir/v3/ParticipationType'
    @_codeSystemFhirMap['RXNORM'] = 'http://www.nlm.nih.gov/research/umls/rxnorm'
    @_codeSystemFhirMap['ReligiousAffiliation'] = 'http://hl7.org/fhir/v3/ReligiousAffiliation'
    @_codeSystemFhirMap['RoleClass'] = 'http://hl7.org/fhir/v3/RoleClass'
    @_codeSystemFhirMap['RoleCode'] = 'http://hl7.org/fhir/v3/RoleCode'
    @_codeSystemFhirMap['RoleStatus'] = 'http://hl7.org/fhir/v3/RoleStatus'
    @_codeSystemFhirMap['SOP'] = 'http://www.nlm.nih.gov/research/umls/sop'
    @_codeSystemFhirMap['UCUM'] = 'http://unitsofmeasure.org'
