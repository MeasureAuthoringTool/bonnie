...
echo 'Running spec/javascripts/admin_views ...'
...
echo 'Running spec/javascripts/patient_builder_tests/input_views_1 tests ...'
bundle exec rake teaspoon DIR='patient_builder_tests/input_views_1'
echo 'Running spec/javascripts/patient_builder_tests/input_views_2 tests ...'
bundle exec rake teaspoon DIR='patient_builder_tests/input_views_2'
echo 'Running spec/javascripts/patient_builder_tests/input_views_3 tests ...'
bundle exec rake teaspoon DIR='patient_builder_tests/input_views_3'
...
echo 'Running spec/javascripts/patient_builder_tests/criteria tests ...'
bundle exec rake teaspoon DIR='patient_builder_tests/criteria'
