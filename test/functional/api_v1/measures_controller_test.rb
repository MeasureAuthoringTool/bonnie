  ...
  class MeasuresControllerTest < ActionController::TestCase
    ...
    test 'should choose default titles for populations' do
      ...
      VCR.use_cassette('api_valid_vsac_response_def_titles', @vcr_options) do
        ...
        assert_equal 2, measure.population_sets[1].stratifications.size
    ...
    test 'should update a measure with provided population titles for populations' do
      ...
      # TODO(cqm_patient): I don't see where any Patients are added to the database, so this might be a noop
    ...
    test 'should return error on updating measure with incorrect hqmf_set_id' do
      ...
      VCR.use_cassette('api_incorrect_hqmf_id_vsac_response', @vcr_options) do
        ...
        put :update, {id: '762B1B52-40BF-4596-B34F-4963188E7FF7', measure_file: measure_update_file, calculation_type: 'episode', vsac_tgt: ticket, vsac_tgt_expires_at: @ticket_expires_at}, {'Content-Type' => 'multipart/form-data'}
        assert_response :not_found
