...
module ApiV1
  ...
  #   end
    ...
    #     assert_equal "Stratification 1", measure.population_sets[0].stratifications[0].title
    #     assert_equal "Stratification 2", measure.population_sets[0].stratifications[1].title
    #     assert_equal "Stratification 1", measure.population_sets[1].stratifications[0].title
    #     assert_equal "Stratification 2", measure.population_sets[1].stratifications[1].title
    #   end
    # end
    ...
    #   @request.env["CONTENT_TYPE"] = "multipart/form-data"
    #   VCR.use_cassette("valid_vsac_response_composite_api", @vcr_options) do
    #     api = Util::VSAC::VSACAPI.new(config: APP_CONFIG['vsac'], username: ENV['VSAC_USERNAME'], password: ENV['VSAC_PASSWORD'])
    #     ticket = api.ticket_granting_ticket[:ticket]
    #     post :create, {
