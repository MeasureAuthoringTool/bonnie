  ...
  class MeasuresControllerTest < ActionController::TestCase
    ...
    test 'should create api_v1_measure initial' do
      ...
      VCR.use_cassette('api_valid_vsac_response', @vcr_options) do
        post :create, params: {vsac_query_type: 'profile', vsac_query_profile: 'Latest eCQM', vsac_query_measure_defined: 'true', vsac_api_key: ENV['VSAC_API_KEY'], measure_file: measure_file, calculation_type: 'patient'}
        assert_response :success
    ...
    test 'should use provided population titles for populations' do
      ...
      VCR.use_cassette('api_valid_vsac_response_provided_titles', @vcr_options) do
        ...
        post :create, params: {vsac_query_type: 'profile', vsac_query_profile: 'Latest eCQM', vsac_query_measure_defined: 'true', vsac_api_key: ENV['VSAC_API_KEY'], measure_file: measure_file, calculation_type: 'episode', population_titles: ['First Pop', 'First Strat', 'Second Strat', 'Third Strat']}
        assert_response :ok
        expected_response = { 'status' => 'success', 'url' => '/api_v1/measures/4DC3E7AA-8777-4749-A1E4-37E942036076'}
        assert_equal expected_response, JSON.parse(response.body)
    ...
    test 'should update a measure with provided population titles for populations' do
      ...
      VCR.use_cassette('api_valid_vsac_response_update', @vcr_options) do
        put :update, params: {id: '4DC3E7AA-8777-4749-A1E4-37E942036076', vsac_query_type: 'profile', vsac_query_profile: 'Latest eCQM', vsac_query_measure_defined: 'true', vsac_api_key: ENV['VSAC_API_KEY'], measure_file: measure_file1, calculation_type: 'episode', population_titles: %w[Foo bar baz bam]}
        assert_response :ok
        expected_response = { 'status' => 'success', 'url' => '/api_v1/measures/4DC3E7AA-8777-4749-A1E4-37E942036076' }
        assert_equal expected_response, JSON.parse(response.body)
      end
    ...
    test 'should error on upload due to incorrect VSAC release parameter input' do
      ...
      VCR.use_cassette('api_invalid_release_vsac_response', @vcr_options) do
        ...
        post :create, params: {vsac_query_type: 'release', vsac_query_release: 'Fake 1234', vsac_query_measure_defined: 'true', vsac_api_key: ENV['VSAC_API_KEY'], measure_file: measure_file, calculation_type: 'episode'}
        assert_response :bad_request
    ...
    test 'should error on measure with missing value sets' do
      ...
      VCR.use_cassette('api_missing_vs_vsac_response', @vcr_options) do
        ...
        post :create, params: {vsac_query_type: 'profile', vsac_query_profile: 'Latest eCQM', vsac_query_measure_defined: 'true', vsac_api_key: ENV['VSAC_API_KEY'], measure_file: measure_file, calculation_type: 'episode'}
        assert_response :bad_request
    ...
    test 'should return 404 on updating non existent measure' do
      ...
      VCR.use_cassette('api_valid_vsac_response_non_exist_measure', @vcr_options) do
        ...
        put :update, params: {id: '762B1B52-40BF-4596-B34F-4963188E7FF7', vsac_query_type: 'profile', vsac_query_profile: 'Latest eCQM', vsac_query_measure_defined: 'true', vsac_api_key: ENV['VSAC_API_KEY'], measure_file: measure_update_file, calculation_type: 'episode'}
    ...
    test 'should return error on updating measure with incorrect hqmf_set_id' do
      ...
      VCR.use_cassette('api_incorrect_hqmf_id_vsac_response', @vcr_options) do
        ...
        put :update, params: {id: '4DC3E7AA-8777-4749-A1E4-37E942036076', measure_file: measure_update_file, calculation_type: 'episode', vsac_api_key: ENV['VSAC_API_KEY']}
        assert_response :not_found
    ...
    test 'should calculate supplemental data elements' do
      ...
      VCR.use_cassette('api_ccdelookback_vsac_response', @vcr_options) do
        post :create, params: {vsac_query_measure_defined: 'false', vsac_query_include_draft: 'false', vsac_api_key: ENV['VSAC_API_KEY'], measure_file: measure_file, calculation_type: 'episode', calculate_sdes: 'true'}
        assert_response :success
    ...
    test 'should not calculate supplemental data elements' do
      ...
      VCR.use_cassette('api_release_ccdelookback_vsac_response', @vcr_options) do
        post :create, params: {vsac_query_type: 'release', vsac_query_measure_defined: 'true', vsac_api_key: ENV['VSAC_API_KEY'], measure_file: measure_file, calculation_type: 'episode', calculate_sdes: 'false'}
        assert_response :success
        measure = CQM::Measure.where({hqmf_set_id: 'FA75DE85-A934-45D7-A2F7-C700A756078B'}).first
