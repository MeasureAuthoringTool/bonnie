...
class BonnieDbTest < ActiveSupport::TestCase
  setup do
    ...
    @set_id_3 = '848D09DE-7E6B-43C4-BEDD-5A2957CCFFE3'
    ...
    CQM::Measure.where(set_id: @set_id_1).first.package.delete
  ...
  test 'download_measure_package bad environment variables' do
    ...
    # Bad set_id
    ENV['EMAIL'] = @email
    ENV['set_id'] = 'A4B9763C-847E-4E02-BB7E-ACC596E9zzzz'
    ...
    assert_output("\e[31m[Error]\e[0m\t\tExpected CMS_ID or set_id environment variables\n") { Rake::Task['bonnie:db:download_measure_package'].execute }
  end
  ...
  test 'download_measure_package' do
    ...
    # access the package with set_id
    ENV['EMAIL'] = @email
    ENV['set_id'] = @set_id_2
    ENV['CMS_ID'] = nil
    ...
    measure = CQM::Measure.find_by(set_id: @set_id_2)
