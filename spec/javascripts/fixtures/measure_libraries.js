...
allTrue = function() {
  ...
  precondition = arguments[0], patient = arguments[1], initialSpecificContext = arguments[2], valueFns = 4 <= arguments.length ? __slice.call(arguments, 3) : [];
  return function() {
    var value, valueFn, values, _i, _len;
    values = [];
    ...
    if (values.length === valueFns.length) {
      return hqmf.SpecificsManager.intersectAll(new Boolean(values.length > 0), values);
    } else {
