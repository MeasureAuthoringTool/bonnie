describe 'MeasureCollection', ->
  ...
  describe 'front end measures', ->
    beforeAll ->
      ...
      @measureCMS158 = new Thorax.Models.Measure getJSONFixture('cqm_measure_data/core_measures/CMS158/CMS158v6.json'), parse: true
      @measureCMS160 = new Thorax.Models.Measure getJSONFixture('cqm_measure_data/core_measures/CMS160/CMS160v6.json'), parse: true
      @measureCMS177 = new Thorax.Models.Measure getJSONFixture('cqm_measure_data/core_measures/CMS177/CMS177v6.json'), parse: true
      @measureCMS32 = new Thorax.Models.Measure getJSONFixture('cqm_measure_data/core_measures/CMS32/CMS32v7.json'), parse: true
