  ...
  describe 'InstantView', ->
    ...
    describe 'initialization', ->
      ...
      it 'invalid by default if not allowNull  ', ->
        view = new Thorax.Views.InputInstantView({ allowNull: false })
        view.render()
      ...
      it 'valid by default if allowNull  ', ->
        view = new Thorax.Views.InputInstantView({ allowNull: true })
        view.render()
      ...
      it 'can start with a fully filled datetime', ->
        date = cqm.models.PrimitiveInstant.parsePrimitive('2012-02-23T08:15:00')
        view = new Thorax.Views.InputInstantView({ initialValue: date })
        view.render()
      ...
      it 'can default to null datetime if none is provided', ->
        view = new Thorax.Views.InputInstantView()
        view.render()
