describe 'InputView', ->
  ...
  describe 'CodeView', ->
    ...
    it 'starts with value in measure value sets', ->
      ...
      initialCode = new cqm.models.CQL.Code('191618007', '2.16.840.1.113883.6.96', null, "Bipolar affective disorder, current episode manic (disorder)")
    ...
    it 'starts with value not in measure value sets', ->
      ...
      initialCode = new cqm.models.CQL.Code('467186001', '2.16.840.1.113883.6.96', null, "Cross-country skiing exerciser (physical object)")
      view = new Thorax.Views.InputCodeView(initialValue: initialCode, cqmValueSets: @measure.get('cqmValueSets'), codeSystemMap: @measure.codeSystemMap())
      view.render()
      expect(view.hasValidValue()).toBe true
    ...
    it 'starts with value not in measure value sets and custom codesystem', ->
      ...
      initialCode = new cqm.models.CQL.Code('1233.22', 'QUODE', null, null)
      view = new Thorax.Views.InputCodeView(initialValue: initialCode, cqmValueSets: @measure.get('cqmValueSets'), codeSystemMap: @measure.codeSystemMap())
      view.render()
      expect(view.hasValidValue()).toBe true
    ...
    it 'starts with no valid value, selects from value set, and goes back to no selection', ->
      ...
      # check value
      expect(view.value).toEqual new cqm.models.CQL.Code("296.65", "2.16.840.1.113883.6.103", null, "Bipolar I disorder, most recent episode (or current) mixed, in partial or unspecified remission")
